...
This project is a game where users can test their knowledge answering trivia question. It is a web application that allows people to hold trivia on a regular basis using a webpage to manage the trivia questions and answers.

The project was to create an API and test suite for implementing the following functionality:
...
- [SQLAlchemy](https://www.sqlalchemy.org/) is the Python SQL toolkit and ORM we'll use handle the lightweight sqlite database. You'll primarily work in app.py (__init__.py) and can reference models.py.
...
## Authors
- Chadrick Hendon authored the API('__init__.py') and test suite ('test_flaskr.py) to integrate with the frontend.
